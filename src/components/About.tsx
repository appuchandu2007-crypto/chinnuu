  ...
  return (
    <section id="about" className="py-16 px-4 max-w-6xl mx-auto">
      <div className="space-y-16">
        ...
        {/* Why Choose Us */}
        <div id="why-choose-us" className="bg-white p-8 md:p-12 rounded-3xl border border-pink-100 shadow-xl shadow-pink-100/50">
          <h2 className="text-3xl md:text-4xl font-bold text-pink-600 mb-6 flex items-center gap-3">
          ...
          <div className="space-y-4 text-slate-600 text-lg leading-relaxed">
            ...
            <p className="font-semibold text-slate-900">That’s exactly why this platform exists.</p>
            <p>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-3xl border border-pink-100 shadow-xl shadow-pink-100/50">
            <h2 className="text-2xl md:text-3xl font-bold text-pink-600 mb-6 flex items-center gap-3">
            ...
            <ul className="space-y-4 text-slate-600 text-lg">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-pink-600 font-semibold">100% safe and confidential</span>
              </li>
            </ul>
          </div>
        ...
        {/* How we started */}
        <div className="bg-white p-8 md:p-12 rounded-3xl border border-pink-100 shadow-xl shadow-pink-100/50">
          <h2 className="text-3xl md:text-4xl font-bold text-pink-600 mb-6">How we started?</h2>
          <div className="space-y-4 text-slate-600 text-lg leading-relaxed">
            <p>
